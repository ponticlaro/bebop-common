...
/**
 * Common utilities used by several components
 *
 * @package Bebop\Common
 * @since 1.0.0
 * @api
...
class Utils {
   ...
   * Slugifies string.
   *
   * List of performed manipulations:
   * - Removes accents
   ...
   */
  public static function slugify( $string, $options = [ "separator" => "_" ] )
  { 
   ...
   */
  public static function getControlNamesFromCallable( $callable, array $args = [] )
  {   
    $names = [];
